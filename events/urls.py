...
from .views import listar_treinamentos_marcados,conferir_treinamento,iniciar_treinamento,adicionar_participante,finalizar_treinamento,gerar_relatorio,criar_evento,criar_aula
